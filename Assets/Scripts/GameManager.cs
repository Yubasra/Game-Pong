...
public class GameManager : MonoBehaviour
{
    ...
    //Pemain 1
    [SerializeField] PlayerControl player1; //skrip
    private Rigidbody2D player1Rigidbody;

    //Pemain 2
    [SerializeField] PlayerControl player2; //skrip
    private Rigidbody2D player2Rigidbody;

    //Bola
    [SerializeField] BallControl ball; //Skrip
    ...
    //Initialisasi rigibody dan colider
    ...
    void OnGUI()
    {
        ...
        GUI.Label(new Rect(Screen.width / 2 - 150 - 12, 30, 200, 200), "" + player1.Score);
        GUI.Label(new Rect(Screen.width / 2 + 150 + 12, 30, 200, 200), "" + player2.Score);
